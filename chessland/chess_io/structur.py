...
start_left = np.array(star_left, dtype = np.chararray)
num_star_left  =    [[56],        
                   [57, 48],       
                 [58, 49, 40],
               [59, 50, 41, 32],
             ...
             [39, 30, 21, 12, 3],
               [31, 22, 13, 4],
                 [23, 14, 5],
                   [15, 6],          
                     [7]]
num_start_left = np.array(num_star_left, dtype = np.chararray)
...
num_start_right = np.array(num_star_right, dtype = np.chararray)
...
switchSquare = {y: x for x, y in reset.items()}
