...
#nstar_right = np.array(nstar_right, dtype = np.uint16)
...
s_left  =        [['56'],        
                  ...
                  ['15','6'],          
                  ['7']]
s_left = np.array(s_left, dtype = np.chararray)
pprint([np.array(i, dtype = np.chararray) for i in s_left])   

pprint(s_left)
#s_left = np.array(s_left, dtype = np.uint16)
...
s_left1  =        [[56],        
                  ...
                  [15,6],          
                  [7]]
pprint([np.array(i, dtype = np.uint8) for i in s_left1])
xx =[np.array(i, dtype = np.uint8) for i in s_left1]
pprint(xx)